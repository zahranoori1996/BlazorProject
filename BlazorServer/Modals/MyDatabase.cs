namespace BlazorServer.Modals
{
    public static class MyDatabase
    {
        ...
        private static List<Server> Servers = new List<Server>
        {
            ...
            new Server(){ ServerId = 15 , ServerName = "سرور ترکیه 1"       , ServerCountry = "ایران"         , ServerIsOnline = true  },
            ...
            new Server(){ ServerId = 19 , ServerName = "سرور قطر 1"         , ServerCountry = "ایران"           , ServerIsOnline = true  },
            ...
            new Server(){ ServerId = 26 , ServerName = "سرور سوئیس 2"       , ServerCountry = "ایران"         , ServerIsOnline = false },
            new Server(){ ServerId = 27 , ServerName = "سرور سوئد 1"        , ServerCountry = "سوئد"          , ServerIsOnline = true  },
            new Server(){ ServerId = 28 , ServerName = "سرور سوئد 2"        , ServerCountry = "ایران"          , ServerIsOnline = false },
            ...
            new Server(){ ServerId = 31 , ServerName = "سرور دانمارک 1"     , ServerCountry = "ایران"       , ServerIsOnline = true  },
            ...
            new Server(){ ServerId = 38 , ServerName = "سرور چین 2"         , ServerCountry = "ایران"           , ServerIsOnline = false },
            ...
            new Server(){ ServerId = 41 , ServerName = "سرور کره جنوبی 1"   , ServerCountry = "ایران"     , ServerIsOnline = true  },
            ...
            new Server(){ ServerId = 47 , ServerName = "سرور استرالیا 1"    , ServerCountry = "ایران"      , ServerIsOnline = true  },
            new Server(){ ServerId = 48 , ServerName = "سرور استرالیا 2"    , ServerCountry = "استرالیا"      , ServerIsOnline = false },
            new Server(){ ServerId = 49 , ServerName = "سرور آفریقای جنوبی 1", ServerCountry = "ایران", ServerIsOnline = true  },
        ...
        {
            "ایران", "هلند", "آلمان", "امارات","فرانسه"
        };
        #endregion
        ...
        public static void Update(int id, Server updatedServer)
        {
        ...
        public static void Remove(int serverId)
        {
        ...
        public static List<string> GetCountries() => countries;
        public static List<string> GetListCountries() =>
            Servers.Select(s => s.ServerCountry).Distinct().ToList();
    }
}
